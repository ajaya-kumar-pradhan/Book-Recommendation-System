# 📚 PageMatch: Kindle Book Recommendation Engine
...
**PageMatch** is a production-style book recommendation system that mirrors how personalisation engines operate inside platforms like Amazon, Netflix, and Spotify — finding what you'll love based on what readers like you already rated.
...
|---|---|
| ![Publishers](assets/publishers_chart.png) | ![Authors](assets/authors_chart.png) |
