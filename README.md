...
USA vs Canada average user age — tested for regional demographic difference
Age of high-raters (≥5) vs low-raters (<5) — tested age-engagement relationship
Number of ratings for high-rated vs low-rated books — tested popularity-quality link
---
🛠️ Tech Stack
Category	Tools
Language	Python 3.x
...
![GitHub](https://img.shields.io/badge/GitHub-ajayaconnect-181717?style=flat-square&logo=github)
